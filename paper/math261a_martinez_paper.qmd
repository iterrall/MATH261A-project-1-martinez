...
* **Education (edu)**: Percent of adults age 25 years and older without a high school diploma, which was derived as 100 minus the share of adults with at least a diploma [@acs_census; @census_portal].
...
cor_tbl <- cor(
  to_analyze_df_3vars[, c("pov", "edu", "unemp")],
...
ggplot(to_analyze_df_3vars, aes(edu, pov, color = unemp)) +
